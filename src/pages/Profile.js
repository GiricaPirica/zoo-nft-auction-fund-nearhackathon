            ...
            if (startPrice && currentToken.token_id) {
                ...
                if (storageAccount > 0) {
                    ...
                    notification["warning"]({
                        ...
                        description:
                          'Your Storage Balance is not enough to auction on a new NFT. Please refill!',
                      });
                }
            }
        ...
        <div>
            <div className='ticket'>
                ...
                <div className='ticket-guild'>
                    1-star VIP: You can use a one-time ticket to visit the zoo. <br/>
                    2-star VIP: You can use the ticket twice to visit the zoo.<br/>
                    ....<br/>
                    5-star VIP: You can use the ticket 5 times to visit the zoo.<br/>
                    <br/>
                    The probability of minting 1,2,3,4,5 stars is:  50%, 20%, 12%, 8%, 1% respectively
                </div> 
                                ...
                                return (
                                    <Card
                                        ...
                                        actions={[
                                            ...
                                            <b onClick={() => handleAuctionToken(nft)} key={"sell"}><DollarCircleOutlined /> <br/>Auction NFT</b>,
                                        ]}
                                    >
                                        <div style={{ fontSize: '20px' }}> <CrownFilled /> ZOO TICKET </div>
                                        
                                        <Card>VIP: {stars[nft.metadata.quality-1]} </Card> <br/>
