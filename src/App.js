  ...
  return (
      <Layout style={{minHeight: '100vh'}}>
          <Layout>
                ...
                <div className='menu'>    
                    <a href="/mint">
                        <img className="logo" src={require('./assets/logo-zoo.png')} alt="Logo" />    
                    </a>           
                    <div className='list-item'>
                        <ul className='menu-item font-bold'>
                            <li className='list-item-li'>
                                <Link to={"/auctions"} className="text-white"> Auction NFTs</Link>
                            </li>
                            <li className='list-item-li'>
                                <Link to={"/profile"} className="text-white"> My NFT Tickets </Link>
                            </li>
                            <li className='list-item-li'>
                                <Link to={"/mint"} className="text-white"> Get Zoo Ticket </Link>
                            </li>
                        </ul>
                    </div> 
              ...
              <Footer style={{ textAlign: 'center' }}>
                <a href="https://github.com/ngocducedu/zoo-nft-auction-fund-nearspringhackathon">
                    ZOO NFT AUCTION RAISE FUND Github    
                </a> 
                </Footer>
          </Layout>
      </Layout>
